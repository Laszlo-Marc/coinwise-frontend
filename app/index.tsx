      ...
      >
        ...
        >
          ...
          <View style={styles.quickActions}>
            ...
            <TouchableOpacity style={styles.actionButton}>
              <View style={styles.actionIconContainer}>
                <RefreshCcw color={colors.text} size={24} />
              </View>
        ...
        {/* Widgets Title Section */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Widgets</Text>
          <TouchableOpacity style={styles.addButton}>
            <Plus color={colors.primary[400]} size={20} />
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.cardsContainer}>
            <View style={styles.cardItem}>
              <View style={styles.virtualCard}>
                <Text style={styles.cardLogo}>R</Text>
                <View style={styles.cardChip} />
              </View>
              <Text style={styles.cardLabel}>Single-use</Text>
            </View>

            <TouchableOpacity style={styles.cardItem}>
              <View style={styles.addCardButton}>
                <Plus color={colors.primary[400]} size={24} />
              </View>
              <Text style={styles.cardLabelBlue}>Get card</Text>
            </TouchableOpacity>
          </View>
        </View>
